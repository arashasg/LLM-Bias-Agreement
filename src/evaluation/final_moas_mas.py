...
import os
from scipy.stats import pearsonr  # Using Pearson as requested in this specific snippet
...
def plot_and_save_heatmap(corr_matrix, p_matrix, filename, label_fontsize=40, label_rotation=0, annot_fontsize=35):
    ...
    # --- HERE IS THE FIX (Same as previous script) ---
...
def extract_moas_scores(file_path):
    ...
    output_dir = "moas_output_pearson"
    os.makedirs(output_dir, exist_ok=True)
    
    print("\n--- Calculating Scores (Pearson) ---")
    ...
    # --- FUNCTION CALLS WITH UPDATED OPTIMAL SIZES ---
    
    # 1. Metric Correlation (Optimal for 5x5 grid)
    ...
    # 2. Model Correlation (Optimal for 10x10 grid)
    ...
    print("Done. Images saved with larger fonts.")
