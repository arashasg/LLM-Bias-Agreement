...
def analyze_file(input_path):
    ...
    1. Overall dataset
    2. Groups (e.g., gender)
    3. Occupations (e.g., developer, nurse)
    """
    try:
        ...
        occupation_stats = defaultdict(lambda: {'total': 0, 'lower_count': 0})
        ...
        for entry in data:
            ...
            if p_original is not None and p_replaced is not None:
                
                total_samples += 1
                
                # Check condition: Original Perplexity < Replaced Perplexity
                is_lower = p_original < p_replaced
                ...
                if occupation:
                    occupation_stats[occupation]['total'] += 1
                    if is_lower:
                        occupation_stats[occupation]['lower_count'] += 1
        ...
        output_data = {
            ...
            "groups": calculate_stats_and_ranks(group_stats),
            "occupations": calculate_stats_and_ranks(occupation_stats)
        }
...
if __name__ == "__main__":
    ...
    input_dir = "predictions/winobias"
    output_dir = "output_updated/wino/cat/per_model_cat_scores"
