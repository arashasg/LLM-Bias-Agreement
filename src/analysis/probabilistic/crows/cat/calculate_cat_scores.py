...
def analyze_file(input_path):
    ...
    try:
        ...
        for entry in data:
            ...
            # "sentence_perplexity_score" usually refers to the original sentence in this schema
        ...
        for rank, (group, distance) in enumerate(temp_ranking_data, 1):
            ...
            output_data["groups"][group]["distance_from_0.5"] = distance # Optional: storing the distance metric
...
if __name__ == "__main__":
    ...
    input_dir = "predictions/crowspairs"
    output_dir = "output_updated/crows/cat/per_model_cat_scores"
