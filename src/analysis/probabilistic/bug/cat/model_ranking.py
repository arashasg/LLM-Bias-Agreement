...
def generate_model_rankings_from_cat_scores(input_folder, output_file_path):
    """
    Ranks models based on the distance of their 'ratio' from 0.5.
    ...
    for file_path in files:
        ...
        try:
            ...
            # Extract Ratio directly from the root of the JSON object
            # New structure: {"total_samples": ..., "stereotypical_samples": ..., "ratio": ...}
            ...
            if ratio is not None:
                ...
                print(f"Warning: 'ratio' property missing in {filename}")

        except Exception as e:
            print(f"Error processing {filename}: {e}")

    # Rank Models
    # Sort by distance ascending (smaller distance = rank 1 = less bias)
...
if __name__ == "__main__":
    ...
    input_directory = "output_updated/bug/cat/per_model_cat_scores" 
    output_json_path = "output_updated/bug/cat/model_ranking.json"
